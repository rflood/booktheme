<?php get_header(); ?><!-- created on page 103 -->
					...
					<section id="content" class="widecol alignleft">	
						...
						<div>
							<img width="530" height="95" src="imgs/page-featured-image.jpg" class="attachment-page-featured-image wp-post-image" alt="" title="example" /><!-- modified on page 155 and page 195-->
						</div><!-- featured image -->
						...
						<nav class="breadcrumb">
							...
							<a title="Go to Home." href="http://localhost/j2-theme">Home</a> &raquo; About The Theme<!-- modified on pages 155-157 and page THIS IS GOING TO REQUIRE THE PLUGIN BREADCRUMB NAVXT TO BE INSTALLED-->
						</nav>
						...
						<article class="page"><!-- Post Class page 248 -->
							...
							<header>
								<h1 class="text-shad-lt">About The Tests</h1><!-- modified on page 157 -->
							</header>				
							
							<h2 class="tagline"><!-- The EXCERPT --></h2><!-- modified on page 158 -->
